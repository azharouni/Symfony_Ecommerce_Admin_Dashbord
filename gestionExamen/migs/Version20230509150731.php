 ...
 */
final class Version20230509150731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD image VARCHAR(500) NOT NULL, CHANGE num_tel num_tel INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP image, CHANGE num_tel num_tel INT DEFAULT NULL');
