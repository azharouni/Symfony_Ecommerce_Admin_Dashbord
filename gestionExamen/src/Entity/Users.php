...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'users', targetEntity: Adresse::class ,cascade: ['persist', 'remove'])]    // #cascade: ['persist', 'remove'])
    ...
    {
        $this->setPassword($passwordHasher->hashPassword($this, $this->getPassword()));
    }
